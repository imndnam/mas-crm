...
$languageStrings = array(
	...
	'LBL_MARK_MESSAGE_AS' => 'Marcar mensaje como',
        ...
        'SELECT_FOLDERS'   =>   'Selecciona Carpetas',
        'ADD_RULES'   =>   'Añadir Reglas',
        'CREATE_Leads_SUBJECT'   =>   'Crear PreContacto',
        'CREATE_Contacts_SUBJECT'   =>   'Crear Contacto',
        'CREATE_Accounts_SUBJECT'   =>   'Crear Organización',
        'LBL_ACTIONS'   =>   'Acciones',
        'LBL_MAILBOX'   =>   'Buzón Correo',
        'LBL_RULE'   =>   'Regla',
        ...
        'LBL_MAILCONVERTER_DESCRIPTION' => 'Mail Converter permite configurar su buzón de correo para escanear sus correos electrónicos y crear entidades apropiadas en NCRM. <br> Tendrás que definir las reglas para especificar qué acciones deben realizarse con su correo electrónico. <br> Tus correos electrónicos son leídos de forma automática, a menos que hayas desactivado tarea escáner de correo en el Programador. <br> <br> <br>',
        ...
        'LBL_CONNECTION_TO_MAILBOX_FAILED'   =>   'No se pudo conectar al buzón de correo ! <br> caracteres especiales no están permitidos para el nombre del servidor .',
        'LBL_DELETED_SUCCESSFULLY'   =>   'Eliminados con éxito',
        'LBL_RULE_DELETION_FAILED'   =>   'No se ha podido eliminar la regla',
        'LBL_RULES_SEQUENCE_INFO_IS_EMPTY'   =>   'No hay información de secuencia de reglas',
        'LBL_SEQUENCE_UPDATED_SUCCESSFULLY'   =>   'Secuencia actualizado correctamente',
        'LBL_SCANNED_SUCCESSFULLY'   =>   'Analizado correctamente',
		//Server Messages
	'LBL_MAX_LIMIT_EXCEEDED' => 'Has superado el límite de buzón adicional !',
	'LBL_CONNECTION_TO_MAILBOX_FAILED' => 'No se pudo conectar al buzón de correo ! <br> caracteres especiales no están permitidos para el nombre del servidor .',
	...
	'LINK_Accounts_TO' => 'Añadir a Cuenta [A]',
        'LINK_Leads_FROM'   =>   'Añadir a PreContacto [DE]',
        'LINK_Leads_TO'   =>   'Añadir a PreContacto [A]',
