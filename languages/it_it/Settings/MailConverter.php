...
$languageStrings = array(
    ...
    'LBL_MAILCONVERTER_DESCRIPTION'   =>   "Mail Converter consente di configurare la tua casella di posta per eseguire la scansione dei messaggi di posta elettronica e creare entità appropriate in NCRM. <br> Sarà inoltre necessario definire le regole per specificare quali azioni devono essere eseguite sui vostri email. <br> Le tue email scansionata automaticamente, a meno che non hai disattivato attività Stampa Scanner in Scheduler. <br> <br> <br>",
    ...
    'LBL_CONNECTION_TO_MAILBOX_FAILED'   =>   "Il collegamento alla casella e-mail non riuscita! <br> caratteri speciali non sono ammessi per il nome del server.",
