...
$organization_name = str_replace('.od1.ncrm.com', '', $organization_name);
...
if (isset($_REQUEST['service'])) {
	...
	$cronTasks = array(Ncrm_Cron::getInstance($_REQUEST['service']));
}
else {
	// Run all service
	$cronTasks = Ncrm_Cron::listAllActiveInstances();
}
