...
abstract class MailManager_Abstract_View extends Ncrm_Index_View {
	 ...
	 */
	public function getViewer(Ncrm_Request $request) {
	 ...
	 * @return type
	 */
	public function getOperationArg(Ncrm_Request $request) {
