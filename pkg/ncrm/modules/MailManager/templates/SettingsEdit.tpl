	...
	<form action="javascript:void(0);" method="POST" id="EditView">
		...
		<table class="table table-bordered blockContainer showInlineTable">
			...
			<tbody>
				<tr>
					<td class="fieldLabel">
						<label class="muted marginRight10px">{vtranslate('LBL_SELECT_ACCOUNT_TYPE',$MODULE)}</label>
					</td>
				...
				<tr class="settings_details" {if $SERVERNAME eq ''} style="display:none;"{/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px"><font color="red">*</font> {vtranslate('LBL_Mail_Server',$MODULE)}</label>
					</td>
				...
				<tr class="settings_details" {if $SERVERNAME eq ''} style="display:none;"{/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px"><font color="red">*</font> {vtranslate('LBL_Username',$MODULE)}</label>
					</td>
				...
				<tr class="settings_details" {if $SERVERNAME eq ''} style="display:none;"{/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px"><font color="red">*</font> {vtranslate('LBL_Password',$MODULE)}</label>
					</td>
					<td class="fieldValue narrowWidthType" nowrap>
				...
				<tr class="additional_settings" {if $SERVERNAME neq 'other'} style="display:none;" {/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px">{vtranslate('LBL_Protocol',$MODULE)}</label>
					</td>
					<td class="fieldValue narrowWidthType" nowrap style="width: 70%;">
				...
				<tr class="additional_settings" {if $SERVERNAME neq 'other'} style="display:none;" {/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px">{vtranslate('LBL_SSL_Options',$MODULE)}</label>
					</td>
					<td class="fieldValue narrowWidthType" nowrap>
				...
				<tr class="additional_settings" {if $SERVERNAME neq 'other'} style="display:none;" {/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px">{vtranslate('LBL_Certificate_Validations',$MODULE)}</label>
					</td>
					<td class="fieldValue narrowWidthType" nowrap>
				...
				<tr class="refresh_settings" {if $MAILBOX && $MAILBOX->exists()}{else} style="display:none;" {/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px">{vtranslate('LBL_REFRESH_TIME',$MODULE)}</label>
					</td>
					<td class="fieldValue narrowWidthType" nowrap  style="width: 70%;">
				...
				<tr class="settings_details" {if $SERVERNAME eq ''} style="display:none;"{/if}>
					<td class="fieldLabel" nowrap>
						<label class="muted marginRight10px">{vtranslate('LBL_CHOOSE_EXISTING_FOLDER',$MODULE)}</label>
					</td>
