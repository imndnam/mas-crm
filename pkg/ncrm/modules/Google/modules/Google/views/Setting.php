...
class Google_Setting_View extends Ncrm_PopupAjax_View {
    ...
    public function emitContactsSyncSettingUI(Ncrm_Request $request) {
        ...
        $contactsModuleModel = Ncrm_Module_Model::getInstance($request->get('sourcemodule'));
        ...
        $viewer->assign('NCRM_EMAIL_FIELDS',$emailFields);
        $viewer->assign('NCRM_PHONE_FIELDS',$phoneFields);
        $viewer->assign('NCRM_URL_FIELDS',$urlFields);
        $viewer->assign('NCRM_OTHER_FIELDS',$otherFields);
