...
class Settings_SMSNotifier_Module_Model extends Settings_Ncrm_Module_Model {

	var $baseTable = 'ncrm_smsnotifier_servers';
	...
	public static function deleteRecords($recordIdsList = array()) {
		if ($recordIdsList) {
			...
			$query = 'DELETE FROM ncrm_smsnotifier_servers WHERE id IN (' . generateQuestionMarks($recordIdsList). ')';
