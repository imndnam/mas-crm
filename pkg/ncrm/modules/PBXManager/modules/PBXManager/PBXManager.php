...
require_once 'vtlib/Ncrm/Link.php';
...
class PBXManager extends CRMEntity {
    ...
    var $db;
    var $table_name = 'ncrm_pbxmanager';
    var $table_index = 'pbxmanagerid';
    var $customFieldTable = Array('ncrm_pbxmanagercf', 'pbxmanagerid');
    var $tab_name = Array('ncrm_crmentity', 'ncrm_pbxmanager', 'ncrm_pbxmanagercf');
    var $tab_name_index = Array(
        'ncrm_crmentity' => 'crmid',
        'ncrm_pbxmanager' => 'pbxmanagerid',
        'ncrm_pbxmanagercf' => 'pbxmanagerid');
    var $list_fields = Array(
        /* Format: Field Label => Array(tablename, columnname) */
        // tablename should not have prefix 'ncrm_'
        'Call Status'    => Array('ncrm_pbxmanager', 'callstatus'),
        'Customer' => Array('ncrm_pbxmanager', 'customer'),
        'User' => Array('ncrm_pbxmanager', 'user'),
        'Recording'=> Array('ncrm_pbxmanager', 'recordingurl'),
        'Start Time'=> Array('ncrm_pbxmanager', 'starttime'),
    );
...
//    var $mandatory_fields = Array('assigned_user_id');
    ...
    */
    ...
    function unregisterLookupEvents(){
     ...
     /**
     * To add a link in ncrm_links which is to load our PBXManagerJS.js 
     */
     function addLinksForPBXManager() {
        ...
        Ncrm_Link::addLink($this->tabId, $this->headerScriptLinkType, $this->incominglinkLabel, 'modules/PBXManager/resources/PBXManagerJS.js','','',$handlerInfo);
        $log->fatal('Links added');
    }
    
     /**
     * To remove link for PBXManagerJS.js from ncrm_links
     */
    function removeLinksForPBXManager() {
        global $log;
        //Deleting Headerscripts links
        Ncrm_Link::deleteLink($this->tabId, $this->headerScriptLinkType, $this->incominglinkLabel,'modules/PBXManager/resources/PBXManagerJS.js');
    ...
    */
    function removeSettingsLinks(){
        global $log;
        $adb = PearDatabase::getInstance();
        $adb->pquery('DELETE FROM ncrm_settings_field WHERE name=?', array('LBL_PBXMANAGER'));
    ...
    function removeActionMapping() {
        ...
        $adb->pquery('DELETE FROM ncrm_actionmapping 
