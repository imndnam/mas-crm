...
class PBXManager_PBXManager_Connector {
    ...
    private static $SETTINGS_REQUIRED_PARAMETERS = array('webappurl' => 'text','outboundcontext' => 'text', 'outboundtrunk' => 'text' , 'ncrmsecretkey' => 'text');
    ...
    public function getNcrmSecretKey() {
        return $this->ncrmsecretkey;
    }
    ...
    public function setServerParameters($serverModel) {
        ...
        $this->ncrmsecretkey = $serverModel->get('ncrmsecretkey');
    }
