...
jQuery.Class("ExtensionStore_ExtensionStore_Js", {}, {
    ...
    insertTogglePromotionHtml : function(){
        var toggleHtml = '<span class="btn-group">'+
                        '<button class="btn addButton togglePromotion up">'+
                             '<span id="hide" class="icon fa-chevron-up"></span>'+
                             '<span id="show" class="icon fa-chevron-down hide"></span>'+
                        '</button>'+
                    '</span>';
    ...
    registerEvents: function() {
        ...
        if ((moduleName == "Home") && getPromotion) {
            ...
            jQuery('.togglePromotion').find('.fa-chevron-up').addClass('hide');
            jQuery('.togglePromotion').find('.fa-chevron-down').removeClass('hide');
