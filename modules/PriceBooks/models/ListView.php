...
class PriceBooks_ListView_Model extends Ncrm_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
        ...
        if(!empty($orderBy)){
            ...
            if($orderByFieldModel && ($orderByFieldModel->isReferenceField()
					|| $orderByFieldModel->getFieldDataType() == Ncrm_Field_Model::CURRENCY_LIST)){
		...
		if(!empty($orderBy)) {
            ...
            } else if($orderByFieldModel && $orderByFieldModel->getFieldDataType() == Ncrm_Field_Model::CURRENCY_LIST) {
