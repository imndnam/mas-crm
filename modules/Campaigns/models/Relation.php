...
class Campaigns_Relation_Model extends Ncrm_Relation_Model {
	...
	public function getEmailEnabledModulesInfoForDetailView() {
		return array(
				'Leads' => array('fieldName' => 'leadid', 'tableName' => 'ncrm_campaignleadrel'),
				'Accounts' => array('fieldName' => 'accountid', 'tableName' => 'ncrm_campaignaccountrel'),
				'Contacts' => array('fieldName' => 'contactid', 'tableName' => 'ncrm_campaigncontrel')
		);
	}
	...
	public function getCampaignRelationStatusValues() {
		...
		$result = $db->pquery("SELECT campaignrelstatusid, campaignrelstatus FROM ncrm_campaignrelstatus", array());
