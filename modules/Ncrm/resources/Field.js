...
jQuery.Class("Ncrm_Field_Js",{
	...
	getUiTypeModel : function() {
		...
		var BasicUiTypeClassName = window["Ncrm_"+ typeClassName + "_Field_Js"];
	...
	addValidationToElement : function(element) {
		...
		validationHandler +="funcCall[Ncrm_Base_Validator_Js.invokeValidation]]";
...
Ncrm_Field_Js('Ncrm_Picklist_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Multipicklist_Field_Js',{},{
	/**
	 * Function to get the pick list values
	 * @return <object> key value pair of options
	 */
...
Ncrm_Field_Js('Ncrm_Date_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Currency_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Owner_Field_Js',{},{
...
Ncrm_Date_Field_Js('Ncrm_Datetime_Field_Js',{},{

});

Ncrm_Field_Js('Ncrm_Time_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Recurrence_Field_Js',{},{
