 ...
 * All Rights Reserved.
 *************************************************************************************/
Ncrm_Base_Validator_Js("Ncrm_Email_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var emailInstance = new Ncrm_Email_Validator_Js();
...
Ncrm_Base_Validator_Js("Ncrm_PositiveNumber_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var positiveNumberInstance = new Ncrm_PositiveNumber_Validator_Js();
...
Ncrm_Base_Validator_Js("Ncrm_Integer_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var integerInstance = new Ncrm_Integer_Validator_Js();
...
Ncrm_PositiveNumber_Validator_Js("Ncrm_Percentage_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var percentageInstance = new Ncrm_Percentage_Validator_Js();
...
Ncrm_Base_Validator_Js('Ncrm_Url_Validator_Js',{},{
...
Ncrm_Base_Validator_Js("Ncrm_MultiSelect_Validator_Js",{

	invokeValidation : function(field, rules, i, options) {
		var validatorInstance = new Ncrm_MultiSelect_Validator_Js ();
...
Ncrm_Email_Validator_Js ("Ncrm_MultiEmails_Validator_Js",{
	invokeValidation : function(field) {
		var validatorInstance = new Ncrm_MultiEmails_Validator_Js ();
		validatorInstance.setElement(field);
		var result = validatorInstance.validate();
		if(!result){
			return validatorInstance.getError();
...
Ncrm_PositiveNumber_Validator_Js("Ncrm_GreaterThanZero_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var GreaterThanZeroInstance = new Ncrm_GreaterThanZero_Validator_Js();
...
Ncrm_PositiveNumber_Validator_Js("Ncrm_WholeNumber_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new Ncrm_WholeNumber_Validator_Js();
...
Ncrm_Base_Validator_Js("Ncrm_lessThanToday_Validator_Js",{},{
	...
	validate: function(){
		...
		var fieldValue = this.getFieldValue();
		try{
			var fieldDateInstance = Ncrm_Helper_Js.getDateInstance(fieldValue,fieldDateFormat);
		}
		catch(err){
			this.setError(err);
			return false;
...
Ncrm_Base_Validator_Js("Ncrm_lessThanOrEqualToToday_Validator_Js",{},{
...
Ncrm_Base_Validator_Js('Ncrm_greaterThanOrEqualToToday_Validator_Js',{},{
...
Ncrm_Base_Validator_Js("Ncrm_greaterThanDependentField_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var instance = new Ncrm_greaterThanDependentField_Validator_Js();
		instance.setElement(field);
	...
	getDateTimeInstance : function(field) {
		...
		try{
			var dateTimeInstance = Ncrm_Helper_Js.getDateInstance(fieldValue,dateFormat);
		}
		catch(err){
			this.setError(err);
			return false;
...
Ncrm_Base_Validator_Js("Ncrm_futureEventCannotBeHeld_Validator_Js",{},{
	...
	validate: function(dependentFieldList){
		...
		for(var i=0; i<dependentFieldList.length; i++){
			...
			if(dependentFieldInContext.length > 0){
				...
				var dependentFieldDateInstance = Ncrm_Helper_Js.getDateInstance(fieldValue,dateFormat);
...
Ncrm_Base_Validator_Js("Ncrm_lessThanDependentField_Validator_Js",{},{
...
Ncrm_Base_Validator_Js('Ncrm_Currency_Validator_Js',{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var currencyValidatorInstance = new Ncrm_Currency_Validator_Js();
...
Ncrm_Base_Validator_Js("Ncrm_ReferenceField_Validator_Js",{},{
...
Ncrm_Integer_Validator_Js("Ncrm_Double_Validator_Js",{},{
...
Ncrm_Base_Validator_Js("Ncrm_Date_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var dateValidatorInstance = new Ncrm_Date_Validator_Js();
	...
	validate: function(){
		...
		var fieldValue = this.getFieldValue();
		try{
			Ncrm_Helper_Js.getDateInstance(fieldValue,fieldDateFormat);
		}
		catch(err){
...
Ncrm_Base_Validator_Js("Ncrm_Time_Validator_Js",{
	 ...
	 */
	invokeValidation : function(field, rules, i, options) {
		var validatorInstance = new Ncrm_Time_Validator_Js();
		validatorInstance.setElement(field);
		var result = validatorInstance.validate();
		if(result == true){
			return result;
...
Ncrm_greaterThanDependentField_Validator_Js("Calendar_greaterThanDependentField_Validator_Js",{},{
	...
	getDateTimeInstance : function(field) {
        ...
        var dateFormat = field.data('dateFormat');
        return Ncrm_Helper_Js.getDateInstance(dateFieldValue,dateFormat);
	}

});

Ncrm_Base_Validator_Js('Calendar_greaterThanToday_Validator_Js',{},{
...
Ncrm_Base_Validator_Js("Calendar_RepeatMonthDate_Validator_Js",{
...
Ncrm_WholeNumber_Validator_Js("Ncrm_WholeNumberGreaterThanZero_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var WholeNumberGreaterThanZero = new Ncrm_WholeNumberGreaterThanZero_Validator_Js();
...
Ncrm_Base_Validator_Js("Ncrm_AlphaNumeric_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var alphaNumericInstance = new Ncrm_AlphaNumeric_Validator_Js();
