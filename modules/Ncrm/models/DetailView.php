...
class Ncrm_DetailView_Model extends Ncrm_Base_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if(Users_Privileges_Model::isPermitted($moduleName, 'EditView', $recordId)) {
			...
			$linkModelList['DETAILVIEW'][] = Ncrm_Link_Model::getInstanceFromValues($duplicateLinkModel);
		}
		...
		foreach($relatedLinks as $relatedLinkEntry) {
			$relatedLink = Ncrm_Link_Model::getInstanceFromValues($relatedLinkEntry);
		...
		if($currentUserModel->isAdminUser()) {
			...
			foreach($settingsLinks as $settingsLink) {
				$linkModelList['DETAILVIEWSETTING'][] = Ncrm_Link_Model::getInstanceFromValues($settingsLink);
			}
		}
	...
	public function getSideBarLinks($linkParams) {
		...
		if($currentUser->getTagCloudStatus()) {
			...
			$linkModel = Ncrm_Link_Model::getInstanceFromValues($tagWidget);
