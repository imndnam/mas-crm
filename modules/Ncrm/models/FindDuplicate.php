...
class Ncrm_FindDuplicate_Model extends Ncrm_Base_Model {
	...
	function getListViewHeaders() {
		...
		$listViewHeaders[] = new Ncrm_Base_Model(array('name' => 'recordid', 'label' => 'Record Id'));
	...
	function getListViewEntries(Ncrm_Paging_Model $paging) {
        $db = PearDatabase::getInstance();
        $moduleModel = $this->getModule();
    ...
    public function getMassDeleteRecords(Ncrm_Request $request) {
