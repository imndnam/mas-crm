...
class Ncrm_ModuleMeta_Model extends Ncrm_Base_Model {
	...
	/**
	 * creates an instance of Ncrm_ModuleMeta_Model
	 * @param <String> $name - module name
	 * @param <Object> $user - Users Object
	 * @return Ncrm_ModuleMeta_Model
	 */
	public static function getInstance($name, $user) {
		$self = new Ncrm_ModuleMeta_Model();
		...
		if(method_exists($focus, 'getImportableFields')) {
			...
			foreach($moduleFields as $fieldName => $fieldInstance) {
				if(($this->isEditableField($fieldInstance)
							&& ($fieldInstance->getTableName() != 'ncrm_crmentity' || $fieldInstance->getColumnName() != 'modifiedby')
