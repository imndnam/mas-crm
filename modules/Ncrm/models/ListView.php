 ...
 */
class Ncrm_ListView_Model extends Ncrm_Base_Model {
	...
	public function getSideBarLinks($linkParams) {
		...
		$listLinks = Ncrm_Link_Model::getAllByType($this->getModule()->getId(), $listLinkTypes);
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLinks[] = array(
				...
				'linklabel' => 'LBL_EDIT',
				'linkurl' => 'javascript:Ncrm_List_Js.triggerMassEdit("index.php?module='.$moduleModel->get('name').'&view=MassActionAjax&mode=showMassEditForm");',
				'linkicon' => ''
			);
		}
	...
	public function getListViewHeaders() {
		...
		foreach($headerFields as $fieldName => $webserviceField) {
			...
			$headerFieldModels[$fieldName] = Ncrm_Field_Model::getInstance($fieldName,$module);
		}
	...
	public static function getInstanceForPopup($value) {
		...
		$modelClassName = Ncrm_Loader::getComponentClassName('Model', 'ListView', $value);
		$instance = new $modelClassName();
		$moduleModel = Ncrm_Module_Model::getInstance($value);
	...
	public function getAdvancedLinks(){
		...
		if($duplicatePermission) {
			$advancedLinks[] = array(
				...
				'linkurl' => 'Javascript:Ncrm_List_Js.showDuplicateSearchForm("index.php?module='.$moduleModel->getName().
