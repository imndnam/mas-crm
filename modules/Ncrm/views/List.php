...
class Ncrm_List_View extends Ncrm_Index_View {
	...
	function preProcess(Ncrm_Request $request, $display=true) {
		...
		$listViewModel = Ncrm_ListView_Model::getInstance($moduleName);
	...
	public function initializeListViewContents(Ncrm_Request $request, Ncrm_Viewer $viewer) {
		...
		$viewer->assign('GROUPS_IDS', Ncrm_Util_Helper::getGroupsIdsForUsers($currentUser->getId()));
    ...
    public function transferListSearchParamsToFilterCondition($listSearchParams, $moduleModel) {
        return Ncrm_Util_Helper::transferListSearchParamsToFilterCondition($listSearchParams, $moduleModel);
    }
}