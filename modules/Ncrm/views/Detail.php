...
class Ncrm_Detail_View extends Ncrm_Index_View {
	...
	function preProcess(Ncrm_Request $request, $display=true) {
		...
		$recordStrucure = Ncrm_RecordStructure_Model::getInstanceFromRecordModel($recordModel, Ncrm_RecordStructure_Model::RECORD_STRUCTURE_MODE_DETAIL);
		$summaryInfo = array();
	...
	public function getHeaderScripts(Ncrm_Request $request) {
		...
		$jsFileNames = array(
			...
			'modules.Ncrm.resources.RelatedList',
	 ...
	 * @return <type>
	 */
	function showModuleDetailView(Ncrm_Request $request) {
		$recordId = $request->get('record');
		$moduleName = $request->getModule();
	 ...
	 * @param Ncrm_Request $request
	 */
	function showRecentActivities (Ncrm_Request $request) {
	 ...
	 * @return <type>
	 */
	function showRecentComments(Ncrm_Request $request) {
	...
	function showRelatedList(Ncrm_Request $request) {
		...
		try {
			$targetControllerClass = Ncrm_Loader::getComponentClassName('View', 'In'.$moduleName.'Relation', $relatedModuleName);
		}catch(AppException $e) {
			try {
				// If any module wants to have same view for all the relation, then invoke this.
				$targetControllerClass = Ncrm_Loader::getComponentClassName('View', 'InRelation', $relatedModuleName);
			}catch(AppException $e) {
				// Default related list
				$targetControllerClass = Ncrm_Loader::getComponentClassName('View', 'RelatedList', $moduleName);
			}
		}
	 ...
	 * @return <type>
	 */
	function showChildComments(Ncrm_Request $request) {
	 ...
	 * @return <type>
	 */
	function showAllComments(Ncrm_Request $request) {
		$parentRecordId = $request->get('record');
	 ...
	 */
	public function getActivities(Ncrm_Request $request) {
		return '';
	}
