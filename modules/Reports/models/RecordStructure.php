 ...
 */
class Reports_RecordStructure_Model extends Ncrm_RecordStructure_Model {
	...
	public function getStructure($moduleName) {
		...
		if ($moduleName === 'Emails') {
			$restrictedTablesList = array('ncrm_emaildetails', 'ncrm_attachments');
			...
			$eventsModel = Ncrm_Module_Model::getInstance('Events');
			$recordStructureInstance = Ncrm_RecordStructure_Model::getInstanceForModule($eventsModel);
	 ...
	 * @return <Array of Ncrm_RecordSructure_Models>
	 */
