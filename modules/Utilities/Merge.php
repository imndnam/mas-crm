...
// Fix For: http://trac.ncrm.com/cgi-bin/trac.cgi/ticket/2107
...
$sql = "select filename,data,filesize from ncrm_wordtemplatestorage where filename=?";
...
<OBJECT Name="ncrmVM" codebase="http://<?php echo $_SERVER["HTTP_HOST"] ?>/modules/Settings/ncrmVM.CAB#Version1,0,0,1"
