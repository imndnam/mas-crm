...
class PBXManager_IncomingCallPoll_Action extends Ncrm_Action_Controller{
    ...
    public function checkModuleViewPermission(Ncrm_Request $request){
    ...
    public function searchIncomingCalls(Ncrm_Request $request){
   ...
   public function createRecord(Ncrm_Request $request){
            $user = Users_Record_Model::getCurrentUserModel();
            ...
            foreach($mandatoryFieldModels as $mandatoryField){
                ...
                if(!empty($element[$fieldName])){
                    ...
                    if(empty($fieldValue)) {
                        $fieldValue = Ncrm_Util_Helper::getDefaultMandatoryValue($fieldType);
                    }
    ...
    function checkPermissionForPolling(Ncrm_Request $request) {
        Users_Privileges_Model::getCurrentUserPrivilegesModel();
