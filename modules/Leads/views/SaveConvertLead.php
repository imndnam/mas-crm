...
class Leads_SaveConvertLead_View extends Ncrm_View_Controller {
	...
	public function process(Ncrm_Request $request) {
		...
		$recordModel = Ncrm_Record_Model::getInstanceById($recordId, $request->getModule());
			...
			if(vtlib_isModuleActive($module)&& in_array($module, $modules)) {
				...
				foreach ($convertLeadFields[$module] as $fieldModel) {
					...
					if ($fieldModel->getFieldDataType() === 'currency') {
						$fieldValue = Ncrm_Currency_UIType::convertToDBFormat($fieldValue);
