...
class Install_Index_view extends Ncrm_View_Controller {
	...
	public function preProcess(Ncrm_Request $request, $display = true) {
		...
		if(is_file($configFileName) && filesize($configFileName) > 0) {
			...
			$defaultModuleInstance = Ncrm_Module_Model::getInstance($defaultModule);
	...
	public function Step3(Ncrm_Request $request) {
		$viewer = $this->getViewer($request);
		$moduleName = $request->getModule();
	...
	public function Step4(Ncrm_Request $request) {
		$viewer = $this->getViewer($request);
		$moduleName = $request->getModule();
	...
	public function Step5(Ncrm_Request $request) {
	...
	public function Step6(Ncrm_Request $request) {
		$moduleName = $request->getModule();
		$viewer = $this->getViewer($request);
	...
	public function Step7(Ncrm_Request $request) {
		...
		$moduleName = $request->getModule();
                ...
                if(!$isInstalled){
                    ...
                    $viewer->assign('CURRENT_VERSION', $_SESSION['ncrm_version']);
