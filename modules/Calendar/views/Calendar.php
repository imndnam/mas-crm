...
class Calendar_Calendar_View extends Ncrm_Index_View {
	 ...
	 */
	public function getCalendarSettings(Ncrm_Request $request){
		
		$viewer = $this->getViewer($request);
		$currentUserModel = Users_Record_Model::getCurrentUserModel();
		$module = $request->getModule();
		$detailViewModel = Ncrm_DetailView_Model::getInstance('Users', $currentUserModel->id);
		$userRecordStructure = Ncrm_RecordStructure_Model::getInstanceFromRecordModel($detailViewModel->getRecord(), Ncrm_RecordStructure_Model::RECORD_STRUCTURE_MODE_EDIT);
