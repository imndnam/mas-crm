 ...
 */
class Calendar_ListView_Model extends Ncrm_ListView_Model {
	...
	public function getListViewHeaders() {
		...
		foreach($headerFields as $fieldName => $webserviceField) {
            ...
            $fieldInstance = Ncrm_Field_Model::getInstance($fieldName,$module);
            if(!$fieldInstance) {
                if($moduleName == 'Calendar') {
                    $eventmodule = Ncrm_Module_Model::getInstance('Events');
                    $fieldInstance = Ncrm_Field_Model::getInstance($fieldName,$eventmodule);
                }
            }
