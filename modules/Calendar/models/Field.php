 ...
 */
class Calendar_Field_Model extends Ncrm_Field_Model {
	...
	*/
    ...
    public static function getReccurencePicklistValues() {
		$currentUser = Users_Record_Model::getCurrentUserModel();
		$fieldModel = Ncrm_Field_Model::getInstance('recurringtype', Ncrm_Module_Model::getInstance('Events'));
		if($fieldModel->isRoleBased() && !$currentUser->isAdminUser()) {
			$userModel = Users_Record_Model::getCurrentUserModel();
			$picklistValues = Ncrm_Util_Helper::getRoleBasedPicklistValues('recurringtype', $userModel->get('roleid'));
		}else{
			$picklistValues = Ncrm_Util_Helper::getPickListValues('recurringtype');
		}
