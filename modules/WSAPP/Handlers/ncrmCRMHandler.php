...
class ncrmCRMHandler extends SyncHandler {
        ...
        foreach ($referenceFieldDetails as $referenceFieldName => $referenceModuleDetails) {
            ...
            foreach ($records as $recordDetails) {
                ...
                if (!empty($referenceWsId)) {
                    ...
                    $webserviceObject = NcrmWebserviceObject::fromId($db, $referenceIdComp[0]);
    ...
    /**
     * Function to fillMandatory fields in ncrm with given values
