...
class Settings_ExtensionStore_RestClient {
    ...
    public function __construct() {
        global $site_URL, $current_ncrm_version;

        $this->defaultOptions[CURLOPT_REFERER] = $site_URL;
        $this->defaultOptions[CURLOPT_USERAGENT] = self::$name . '/' . self::$version . '(CRM ' . $current_ncrm_version . ')';
    ...
    protected function exec($curlopts) {
        ...
        fclose($cookiefp); unlink($cookiefile);
