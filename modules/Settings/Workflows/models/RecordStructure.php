...
class Settings_Workflows_RecordStructure_Model extends Ncrm_RecordStructure_Model {
	...
	public static function getInstanceForWorkFlowModule($workFlowModel, $mode) {
		$className = Ncrm_Loader::getComponentClassName('Model', $mode.'RecordStructure', 'Settings:Workflows');
