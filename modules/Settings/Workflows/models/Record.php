...
class Settings_Workflows_Record_Model extends Settings_Ncrm_Record_Model {
...
//			return Ncrm_Language_Handler::getTranslatedString($executionConditionAsLabel, 'Settings:Workflows');
//		}
//		if($key == 'module_name') {
//			$moduleName = parent::get($key);
//			return Ncrm_Language_Handler::getTranslatedString($moduleName, $moduleName);
//		}
	...
	public function getRecordLinks() {
		...
		$recordLinks = array(
			...
			array(
				...
				'linkurl' => 'javascript:Ncrm_List_Js.deleteRecord('.$this->getId().');',
				'linkicon' => 'icon-trash'
			)
		);
	...
	public function getDependentModules() {
		...
		$result = $db->pquery("SELECT fieldname, tabid, typeofdata, ncrm_ws_referencetype.type as reference_module FROM ncrm_field
								INNER JOIN ncrm_ws_fieldtype ON ncrm_field.uitype = ncrm_ws_fieldtype.uitype
								INNER JOIN ncrm_ws_referencetype ON ncrm_ws_fieldtype.fieldtypeid = ncrm_ws_referencetype.fieldtypeid
							UNION
							SELECT fieldname, tabid, typeofdata, relmodule as reference_module FROM ncrm_field
								INNER JOIN ncrm_fieldmodulerel ON ncrm_field.fieldid = ncrm_fieldmodulerel.fieldid", array());
