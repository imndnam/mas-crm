...
class Settings_MailConverter_List_View extends Settings_Ncrm_Index_View {
	...
	public function process(Ncrm_Request $request) {
		...
		$viewer->assign("MODULE_MODEL", Settings_Ncrm_Module_Model::getInstance($qualifiedModuleName));
