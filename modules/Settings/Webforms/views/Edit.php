...
Class Settings_Webforms_Edit_View extends Settings_Ncrm_Index_View {
	...
	public function process(Ncrm_Request $request) {
		...
		$recordStructure = Ncrm_RecordStructure_Model::getInstanceFromRecordModel($recordModel, Ncrm_RecordStructure_Model::RECORD_STRUCTURE_MODE_EDIT);
