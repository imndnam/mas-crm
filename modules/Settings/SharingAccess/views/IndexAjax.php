...
Class Settings_SharingAccess_IndexAjax_View extends Settings_Ncrm_IndexAjax_View {
	...
	public function showRules(Ncrm_Request $request) {
	...
	public function editRule(Ncrm_Request $request) {
