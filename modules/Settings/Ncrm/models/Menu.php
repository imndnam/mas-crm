 ...
 */
class Settings_Ncrm_Menu_Model extends Ncrm_Base_Model {

	protected static $menusTable = 'ncrm_settings_blocks';
	...
	public function getListUrl() {
		return 'index.php?module=Ncrm&parent=Settings&view=ListMenu&block='.$this->getId();
	}
	...
	public function getItems() {
		return Settings_Ncrm_MenuItem_Model::getAll($this);
	}

	/**
	 * Static function to get the list of all the Settings Menus
	 * @return <Array> - List of Settings_Ncrm_Menu_Model instances
	 */
	public static function getAll() {
		...
		for($i=0; $i<$noOfMenus; ++$i) {
			...
			$menuModels[$blockId] = Settings_Ncrm_Menu_Model::getInstanceFromArray($rowData);
		}
		return $menuModels;
	}
	...
	public static function getInstanceById($id) {
		...
		if($db->num_rows($result) > 0) {
			...
			return Settings_Ncrm_Menu_Model::getInstanceFromArray($rowData);
		}
		return false;
	}
