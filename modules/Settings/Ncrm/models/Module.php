 ...
 */
class Settings_Ncrm_Module_Model extends Ncrm_Base_Model {

	var $baseTable = 'ncrm_settings_field';
	...
	public function getField($fieldName) {
		return new Ncrm_Base_Model(array('name' => $fieldName, 'label' => $fieldName));
	}
	...
	public function getMenus() {
		return Settings_Ncrm_Menu_Model::getAll();
	}
	...
	public function getMenuItems($menu=false) {
		$menuModel = false;
		if($menu) {
			$menuModel = Settings_Ncrm_Menu_Model::getInstance($menu);
		}
		return Settings_Ncrm_MenuItem_Model::getAll($menuModel);
	}
