...
class Settings_Ncrm_Systems_Model extends Ncrm_Base_Model{

    const tableName = 'ncrm_systems';
    ...
    public static function getInstanceFromServerType($type,$componentName) {
        ...
        try{
        $modelClassName = Ncrm_Loader::getComponentClassName('Model', $componentName, 'Settings:Ncrm');
        }catch(Exception $e) {
            $modelClassName = self;
        }
