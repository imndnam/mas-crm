...
class Settings_LayoutEditor_Index_View extends Settings_Ncrm_Index_View {
	...
	public function showFieldLayout(Ncrm_Request $request) {
	...
	public function showRelatedListLayout(Ncrm_Request $request) {
		$sourceModule = $request->get('sourceModule');
		$supportedModulesList = Settings_LayoutEditor_Module_Model::getSupportedModules();
