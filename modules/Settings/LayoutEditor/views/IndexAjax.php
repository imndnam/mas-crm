...
class Settings_LayoutEditor_IndexAjax_View extends Settings_Ncrm_IndexAjax_View {
	
	function __construct() {
		$this->exposeMethod('getFieldUI');
	}
    
    public function addBlock(Ncrm_Request $request) {
    ...
    public function getFieldUI (Ncrm_Request $request) {
