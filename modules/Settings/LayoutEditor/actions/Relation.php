...
class Settings_LayoutEditor_Relation_Action extends Settings_Ncrm_Index_Action {
    ...
    public function process(Ncrm_Request $request) {
        ...
        $moduleModel = Ncrm_Module_Model::getInstance($sourceModule, false);
        $relationModulesList = Ncrm_Relation_Model::getAllRelations($moduleModel, false);
        $sequenceList = array();
        ...
        try{
            ...
            Ncrm_Relation_Model::updateRelationSequenceAndPresence($relationUpdateDetail, $moduleModel->getId());
        }
        catch(Exception $e) {
