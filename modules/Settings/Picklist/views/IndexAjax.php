...
class Settings_Picklist_IndexAjax_View extends Settings_Ncrm_IndexAjax_View {
    ...
    public function showEditView(Ncrm_Request $request) {
	...
	//	$selectedFieldAllPickListValues =  array_map('Ncrm_Util_Helper::toSafeHTML', $selectedFieldAllPickListValues);
    ...
    public function showDeleteView(Ncrm_Request $request) {
        $module = $request->get('source_module');
        $pickListFieldId = $request->get('pickListFieldId');
        $fieldModel = Settings_Picklist_Field_Model::getInstance($pickListFieldId);
		...
		$selectedFieldEditablePickListValues = $fieldModel->getEditablePicklistValues($fieldModel->getName());
		$selectedFieldNonEditablePickListValues = $fieldModel->getNonEditablePicklistValues($fieldModel->getName());
		$selectedFieldEditablePickListValues =  array_map('Ncrm_Util_Helper::toSafeHTML', $selectedFieldEditablePickListValues);
		if(!empty($selectedFieldNonEditablePickListValues)) {
			$selectedFieldNonEditablePickListValues =  array_map('Ncrm_Util_Helper::toSafeHTML', $selectedFieldNonEditablePickListValues);
		}
		...
		$viewer->assign('SELECTED_PICKLISTFIELD_EDITABLE_VALUES',$selectedFieldEditablePickListValues);
		$viewer->assign('SELECTED_PICKLISTFIELD_NON_EDITABLE_VALUES',$selectedFieldNonEditablePickListValues);
		$viewer->assign('FIELD_VALUES',array_map('Ncrm_Util_Helper::toSafeHTML', $valueToDelete));
        echo $viewer->view('DeleteView.tpl', $qualifiedName, true);
    }

    public function getPickListDetailsForModule(Ncrm_Request $request) {
    ...
    public function getPickListValueForField(Ncrm_Request $request) {
        $sourceModule = $request->get('source_module');
        ...
        $selectedFieldAllPickListValues = Ncrm_Util_Helper::getPickListValues($fieldModel->getName());
        $viewer = $this->getViewer($request);
    ...
    public function getPickListValueByRole(Ncrm_Request $request) {
        $sourceModule = $request->get('source_module');
        $pickFieldId = $request->get('pickListFieldId');
        $fieldModel = Settings_Picklist_Field_Model::getInstance($pickFieldId);
        $moduleName = $request->getModule();
		...
		$pickListValuesForRole = array_map('Ncrm_Util_Helper::toSafeHTML', $pickListValuesForRole);
        $allPickListValues = Ncrm_Util_Helper::getPickListValues($fieldModel->getName());
		$allPickListValues =  array_map('Ncrm_Util_Helper::toSafeHTML', $allPickListValues);
     ...
     */
    public function showAssignValueToRoleView(Ncrm_Request $request) {
		$sourceModule = $request->get('source_module');
        $pickFieldId = $request->get('pickListFieldId');
        $fieldModel = Settings_Picklist_Field_Model::getInstance($pickFieldId);
