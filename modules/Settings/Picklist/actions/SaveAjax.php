...
class Settings_Picklist_SaveAjax_Action extends Settings_Ncrm_Basic_Action {
    ...
    public function updateDefaultPicklistValues($pickListFieldName,$oldValue,$newValue) {
        $db = PearDatabase::getInstance();            
            ...
            $queryToGetId = 'SELECT id FROM ncrm_users WHERE '.$defaultFieldName.' IN (';
            ...
            for($i=0; $i<$rowCount; $i++) {
                ...
                $record = Ncrm_Record_Model::getInstanceById($recordId, 'Users');
    ...
    public function rename(Ncrm_Request $request) {
        $moduleName = $request->get('source_module');
    ...
    public function remove(Ncrm_Request $request) {
        $moduleName = $request->get('source_module');
     ...
     */
    public function assignValueToRole(Ncrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function saveOrder(Ncrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function enableOrDisable(Ncrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
