...
class Inventory_DetailView_Model extends Ncrm_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if(Users_Privileges_Model::isPermitted($moduleName, 'DetailView', $recordModel->getId())) {
			$detailViewLinks = array( 
                        ...
                        $linkModelList['DETAILVIEW'][] = Ncrm_Link_Model::getInstanceFromValues($detailViewLinks);
                        ...
                        $linkModelList['DETAILVIEW'][] = Ncrm_Link_Model::getInstanceFromValues($sendEmailLink);
		}
