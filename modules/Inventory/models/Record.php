 ...
 */
class Inventory_Record_Model extends Ncrm_Record_Model {
	 ...
	 * @return <Model> returns Ncrm_Record_Model
	 */
	 ...
	 * @param Ncrm_Record_Model $parentRecordModel
	 * @return Inventory_Record_Model
	 */
	public function setParentRecordData(Ncrm_Record_Model $parentRecordModel) {
		...
		foreach ($fieldMappingList as $fieldMapping) {
            ...
            $fieldModel = Ncrm_Field_Model::getInstance($parentField,  Ncrm_Module_Model::getInstance($moduleName));
	...
	public function getPDF() {
		...
		$controllerClassName = "Ncrm_". $moduleName ."PDFController";
    ...
    public function getPDFFileName() {
		...
		if ($moduleName == 'Quotes') {
			...
			$controllerClassName = "Ncrm_QuotePDFController";
		} else {
