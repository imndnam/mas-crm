...
class Potentials_DetailView_Model extends Ncrm_DetailView_Model {
	/**
	...
	public function getDetailViewLinks($linkParams) {
        ...
        $quoteModuleModel = Ncrm_Module_Model::getInstance('Quotes');
	...
	public function getWidgets() {
		...
		$contactsInstance = Ncrm_Module_Model::getInstance('Contacts');
		...
		$productsInstance = Ncrm_Module_Model::getInstance('Products');
