...
// Faq is used to store ncrm_faq information.
class Faq extends CRMEntity {
	var $log;
	var $db;
	var $table_name = "ncrm_faq";
	var $table_index= 'id';
	//fix for Custom Field for FAQ 
        var $tab_name = Array('ncrm_crmentity','ncrm_faq','ncrm_faqcf');  
        var $tab_name_index = Array('ncrm_crmentity'=>'crmid','ncrm_faq'=>'id','ncrm_faqcomments'=>'faqid','ncrm_faqcf'=>'faqid');  
        var $customFieldTable = Array('ncrm_faqcf', 'faqid');  
	...
	function save_module($module)
	{
		...
		$this->insertIntoFAQCommentTable('ncrm_faqcomments', $module);

	}


	/** Function to insert values in ncrm_faqcomments table for the specified module,
	...
	function insertIntoFAQCommentTable($table_name, $module)
	{
		...
		if($comment != '')
		{
			...
			$sql = "insert into ncrm_faqcomments values(?, ?, ?, ?)";
	...
	function generateReportsQuery($module, $queryPlanner) {
	 			...
	 			$query = "from $moduletable
					...
					left join ncrm_products as ncrm_products$module on ncrm_products$module.productid = ncrm_faq.product_id
                    ...
                    left join ncrm_users as ncrm_lastModifiedBy".$module." on ncrm_lastModifiedBy".$module.".id = ncrm_crmentity.modifiedby";
	            return $query;
	}
	...
	function setRelationTables($secmodule){
		$rel_tables = array (
			"Documents" => array("ncrm_senotesrel"=>array("crmid","notesid"),"ncrm_faq"=>"id"),
		);
