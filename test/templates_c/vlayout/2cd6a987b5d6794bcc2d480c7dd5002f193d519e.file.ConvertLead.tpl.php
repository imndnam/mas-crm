<?php /* Smarty version Smarty-3.1.7, created on 2017-10-29 02:50:23
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Leads\ConvertLead.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3123659f541ef1312a4-48275364%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2cd6a987b5d6794bcc2d480c7dd5002f193d519e' => 
    array (
  ...
  'nocache_hash' => '3123659f541ef1312a4-48275364',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f541ef218ba',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f541ef218ba')) {function content_59f541ef218ba($_smarty_tpl) {?>
...
</span><span class="pull-right"><i class="iconArrow<?php if ($_smarty_tpl->tpl_vars['CONVERT_LEAD_FIELDS']->value['Accounts']&&$_smarty_tpl->tpl_vars['MODULE_NAME']->value=="Accounts"){?> icon-inverted fa-chevron-up <?php }elseif(!$_smarty_tpl->tpl_vars['CONVERT_LEAD_FIELDS']->value['Accounts']&&$_smarty_tpl->tpl_vars['MODULE_NAME']->value=="Contacts"){?> icon-inverted fa-chevron-up <?php }else{ ?> icon-inverted fa-chevron-down <?php }?>alignBottom"></i></span></div></div><div id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
?><tr><td class="fieldLabel"><label class='muted marginRight10px'><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span class="redColor">*</span> <?php }?><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
