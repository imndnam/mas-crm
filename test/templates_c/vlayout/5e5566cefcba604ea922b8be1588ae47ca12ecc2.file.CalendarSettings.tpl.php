<?php /* Smarty version Smarty-3.1.7, created on 2017-10-26 20:04:17
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Calendar\CalendarSettings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:469859f23df81e1e30-91707747%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e5566cefcba604ea922b8be1588ae47ca12ecc2' => 
    array (
  ...
  'nocache_hash' => '469859f23df81e1e30-91707747',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59f23df836b8b',
  'variables' => 
  array (
    'MODULE' => 0,
    'RECORD' => 0,
...
<?php if ($_valid && !is_callable('content_59f23df836b8b')) {function content_59f23df836b8b($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['LABEL']->value!='This Year'){?><label class="control control--radio"><?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><option value="<?php echo vtranslate('LBL_SELECT_OPTION','Ncrm');?>
...
</label><div class="controls"><label class="control control--radio">&nbsp;<?php echo vtranslate('Private',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;<input type="radio" value="private"<?php if ($_smarty_tpl->tpl_vars['SHARED_TYPE']->value=='private'){?> checked="" <?php }?> name="sharedtype" /><div class="control__indicator"></div></label><label class="control control--radio">&nbsp;<?php echo vtranslate('Public',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;<input type="radio" value="public" <?php if ($_smarty_tpl->tpl_vars['SHARED_TYPE']->value=='public'){?> checked="" <?php }?> name="sharedtype" /><div class="control__indicator"></div></label><label class="control control--radio">&nbsp;<?php echo vtranslate('Selected Users',$_smarty_tpl->tpl_vars['MODULE']->value);?>
<input type="radio" value="selectedusers" <?php if ($_smarty_tpl->tpl_vars['SHARED_TYPE']->value=='selectedusers'){?> checked="" <?php }?> data-sharingtype="selectedusers" name="sharedtype" id="selectedUsers" /><div class="control__indicator"></div></label><select class="select2 row-fluid <?php if ($_smarty_tpl->tpl_vars['SHARED_TYPE']->value!='selectedusers'){?> hide <?php }?>" id="selectedUsers" name="sharedIds[]" multiple="" data-placeholder="<?php echo vtranslate('LBL_SELECT_USERS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
