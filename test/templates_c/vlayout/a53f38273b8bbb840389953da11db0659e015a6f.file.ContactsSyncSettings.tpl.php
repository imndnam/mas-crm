<?php /* Smarty version Smarty-3.1.7, created on 2017-10-26 15:05:11
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Google\ContactsSyncSettings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2248159f1f9a72209c0-15929170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a53f38273b8bbb840389953da11db0659e015a6f' => 
    array (
  ...
  'nocache_hash' => '2248159f1f9a72209c0-15929170',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f1f9a74ed05',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f1f9a74ed05')) {function content_59f1f9a74ed05($_smarty_tpl) {?>
...
</button><ul class="dropdown-menu dropdown-menu-left" role="menu"><li class="addCustomFieldMapping" data-type="email" data-ncrmfields='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['NCRM_EMAIL_FIELDS']->value);?>
'><a><?php echo vtranslate('LBL_EMAIL',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</a></li><li class="addCustomFieldMapping" data-type="phone" data-ncrmfields='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['NCRM_PHONE_FIELDS']->value);?>
'><a><?php echo vtranslate('LBL_PHONE',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</a></li><li class="addCustomFieldMapping" data-type="url" data-ncrmfields='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['NCRM_URL_FIELDS']->value);?>
'><a><?php echo vtranslate('LBL_URL',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</a></li><li class="divider"></li><li class="addCustomFieldMapping" data-type="custom" data-ncrmfields='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['NCRM_OTHER_FIELDS']->value);?>
...
</option><option value="10" <?php if ($_smarty_tpl->tpl_vars['SYNC_DIRECTION']->value=='10'){?>selected<?php }?>><?php echo vtranslate('LBL_ONLY_SYNC_FROM_GOOGLE_TO_NCRM',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</option><option value="01" <?php if ($_smarty_tpl->tpl_vars['SYNC_DIRECTION']->value=='01'){?>selected<?php }?>><?php echo vtranslate('LBL_ONLY_SYNC_FROM_NCRM_TO_GOOGLE',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
...
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]" /></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("secondaryemail", null, 0);?><td><?php echo vtranslate('Secondary Email',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
" /></td><td><input type="hidden" class="google_field_name" value="<?php echo $_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['email']['name'];?>
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("mobile", null, 0);?><td><?php echo vtranslate('Mobile Phone',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("phone", null, 0);?><td><?php echo vtranslate('Office Phone',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
" /></td><td><input type="hidden" class="google_field_name" value="<?php echo $_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['phone']['name'];?>
" /><?php $_smarty_tpl->tpl_vars['GOOGLE_TYPES'] = new Smarty_variable($_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['phone']['types'], null, 0);?><select class="select2 stretched google-type" style="width:200px;" data-category="phone"><?php  $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['TYPE']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['GOOGLE_TYPES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("homephone", null, 0);?><td><?php echo vtranslate('Home Phone',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
" /></td><td><input type="hidden" class="google_field_name" value="<?php echo $_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['phone']['name'];?>
" /><?php $_smarty_tpl->tpl_vars['GOOGLE_TYPES'] = new Smarty_variable($_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['phone']['types'], null, 0);?><select class="select2 stretched google-type" style="width:200px;" data-category="phone"><?php  $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['TYPE']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['GOOGLE_TYPES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("mailingaddress", null, 0);?><td><?php echo vtranslate('Mailing Address',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("otheraddress", null, 0);?><td><?php echo vtranslate('Other Address',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
"></td><td><input type="hidden" class="google_field_name" value="<?php echo $_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['address']['name'];?>
" /><?php $_smarty_tpl->tpl_vars['GOOGLE_TYPES'] = new Smarty_variable($_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['address']['types'], null, 0);?><select class="select2 stretched google-type" style="width:200px;" data-category="address"><?php  $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['TYPE']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['GOOGLE_TYPES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<?php }?>"data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/></td></tr><tr><?php $_smarty_tpl->tpl_vars['FLDNAME'] = new Smarty_variable("description", null, 0);?><td><?php echo vtranslate('Description',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<input type="hidden" class="ncrm_field_name" value="<?php echo $_smarty_tpl->tpl_vars['FLDNAME']->value;?>
...
" /></td></tr><?php  $_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->_loop = false;
 $_smarty_tpl->tpl_vars['NCRM_FIELD_NAME'] = new Smarty_Variable;
...
$_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->_loop = true;
 $_smarty_tpl->tpl_vars['NCRM_FIELD_NAME']->value = $_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->key;
?><tr><td><?php if ($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gd:email'){?><select class="select2 stretched ncrm_field_name" style="width:200px;" data-category="email"><?php  $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL']->_loop = false;
 $_smarty_tpl->tpl_vars['EMAIL_FIELD_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['NCRM_EMAIL_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['NCRM_FIELD_NAME']->value==$_smarty_tpl->tpl_vars['EMAIL_FIELD_NAME']->value){?>selected<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gd:phoneNumber'){?><select class="select2 stretched ncrm_field_name" style="width:200px;" data-category="phone"><?php  $_smarty_tpl->tpl_vars['PHONE_FIELD_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PHONE_FIELD_LABEL']->_loop = false;
 $_smarty_tpl->tpl_vars['PHONE_FIELD_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['NCRM_PHONE_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['NCRM_FIELD_NAME']->value==$_smarty_tpl->tpl_vars['PHONE_FIELD_NAME']->value){?>selected<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['PHONE_FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gContact:userDefinedField'){?><select class="select2 stretched ncrm_field_name" style="width:200px;" data-category="custom"><?php  $_smarty_tpl->tpl_vars['OTHER_FIELD_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['OTHER_FIELD_LABEL']->_loop = false;
 $_smarty_tpl->tpl_vars['OTHER_FIELD_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['NCRM_OTHER_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['NCRM_FIELD_NAME']->value==$_smarty_tpl->tpl_vars['OTHER_FIELD_NAME']->value){?>selected<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['OTHER_FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gContact:website'){?><select class="select2 stretched ncrm_field_name" style="width:200px;" data-category="url"><?php  $_smarty_tpl->tpl_vars['URL_FIELD_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['URL_FIELD_LABEL']->_loop = false;
 $_smarty_tpl->tpl_vars['URL_FIELD_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['NCRM_URL_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['NCRM_FIELD_NAME']->value==$_smarty_tpl->tpl_vars['URL_FIELD_NAME']->value){?>selected<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['URL_FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
...
<?php }?>" data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/><?php }elseif($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gd:phoneNumber'){?><?php $_smarty_tpl->tpl_vars['GOOGLE_TYPES'] = new Smarty_variable($_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['phone']['types'], null, 0);?><select class="select2 google-type" style="width:200px;" data-category="phone"><?php  $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['TYPE']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['GOOGLE_TYPES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['TYPE']->key => $_smarty_tpl->tpl_vars['TYPE']->value){
$_smarty_tpl->tpl_vars['TYPE']->_loop = true;
?><option value="<?php echo $_smarty_tpl->tpl_vars['TYPE']->value;?>
...
<?php }?>" data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/><?php }elseif($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gContact:userDefinedField'){?><input type="hidden" class="google-type" value="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_type'];?>
"><input type="text" class="google-custom-label" value="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_custom_label'];?>
" style="width:190px;" data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/><?php }elseif($_smarty_tpl->tpl_vars['CUSTOM_FIELD_MAP']->value['google_field_name']=='gContact:website'){?><?php $_smarty_tpl->tpl_vars['GOOGLE_TYPES'] = new Smarty_variable($_smarty_tpl->tpl_vars['GOOGLE_FIELDS']->value['url']['types'], null, 0);?><select class="select2 google-type" style="width:200px;" data-category="url"><?php  $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['TYPE']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['GOOGLE_TYPES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['TYPE']->key => $_smarty_tpl->tpl_vars['TYPE']->value){
$_smarty_tpl->tpl_vars['TYPE']->_loop = true;
?><option value="<?php echo $_smarty_tpl->tpl_vars['TYPE']->value;?>
...
<?php }?>" data-validation-engine="validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]"/><?php }?><a class="deleteCustomMapping pull-right"><i title="Delete" class="icon-trash"></i></a></td></tr><?php } ?></tbody></table><br><br><br></div></div></form><div class="modal-footer"><div class="pull-right cancelLinkContainer" style="margin-top:0px;"><a class="cancelLink" type="reset" data-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
