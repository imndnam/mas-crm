<?php /* Smarty version Smarty-3.1.7, created on 2017-11-25 06:38:51
         compiled from "D:\LynxServer\sites\newcrm.dev\fb\includes\runtime/../../layouts/vlayout\modules\Ncrm\UnifiedSearchResults.tpl" */ ?>
<?php /*%%SmartyHeaderCode:129355a190ffb07bba2-14895572%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da92dce5feac6c6a08b8dbee3cf42ed0509a93ba' => 
    array (
  ...
  'nocache_hash' => '129355a190ffb07bba2-14895572',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a190ffb104ff',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a190ffb104ff')) {function content_5a190ffb104ff($_smarty_tpl) {?>
...
</a></span></span><?php }?></div></div><div class="contents"><?php if ($_smarty_tpl->tpl_vars['totalCount']->value==100){?><div class='alert alert-block'><button type=button class="close" data-dismiss="alert">&times;</button><?php if ($_smarty_tpl->tpl_vars['SEARCH_MODULE']->value){?><?php echo vtranslate('LBL_GLOBAL_SEARCH_MAX_MESSAGE_FOR_MODULE','Ncrm');?>
<?php }else{ ?><?php echo vtranslate('LBL_GLOBAL_SEARCH_MAX_MESSAGE','Ncrm');?>
...
_time" class="pull-right" title="<?php echo Ncrm_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['recordObject']->value->get('createdtime'));?>
"><?php echo Ncrm_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['recordObject']->value->get('createdtime'));?>
</span></a></li><?php }
