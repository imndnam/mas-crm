<?php /* Smarty version Smarty-3.1.7, created on 2017-10-26 15:11:32
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Settings\Ncrm\CompanyDetails.tpl" */ ?>
<?php /*%%SmartyHeaderCode:372159f1fb24662377-31833694%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e8f8b9353e6d7c39e713f967d86740eae10ab35' => 
    array (
  ...
  'nocache_hash' => '372159f1fb24662377-31833694',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f1fb2473986',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f1fb2473986')) {function content_59f1fb2473986($_smarty_tpl) {?>
<input type="hidden" id="supportedImageFormats" value='<?php echo ZEND_JSON::encode(Settings_Ncrm_CompanyDetails_Model::$logoSupportedFormats);?>
...
"><?php if ($_smarty_tpl->tpl_vars['FIELD']->value=='address'){?> <?php echo nl2br($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get($_smarty_tpl->tpl_vars['FIELD']->value));?>
 ...
 <?php }?></td></tr><?php }?><?php } ?></tbody></table></div></div><form class="form-horizontal <?php if (empty($_smarty_tpl->tpl_vars['ERROR_MESSAGE']->value)){?>hide<?php }?>"  id="updateCompanyDetailsForm" method="post" action="index.php" enctype="multipart/form-data"><input type="hidden" name="module" value="Ncrm" /><input type="hidden" name="parent" value="Settings" /><input type="hidden" name="action" value="CompanyDetailsSave" /><div class="control-group"><div class="control-label"><?php echo vtranslate('LBL_COMPANY_LOGO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
