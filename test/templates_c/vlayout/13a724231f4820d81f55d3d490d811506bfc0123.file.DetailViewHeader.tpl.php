<?php /* Smarty version Smarty-3.1.7, created on 2017-11-25 06:21:40
         compiled from "D:\LynxServer\sites\newcrm.dev\fb\includes\runtime/../../layouts/vlayout\modules\Ncrm\DetailViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:94435a190bf4a1ba97-71782303%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '13a724231f4820d81f55d3d490d811506bfc0123' => 
    array (
  ...
  'nocache_hash' => '94435a190bf4a1ba97-71782303',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a190bf4a90a6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a190bf4a90a6')) {function content_5a190bf4a90a6($_smarty_tpl) {?>
...
_detailView_basicAction_<?php echo Ncrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel());?>
...
_detailView_moreAction_<?php echo Ncrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
...
'" <?php }?>><i class="fa fa-angle-left"></i></button><button class="btn" id="detailViewNextRecordButton" <?php if (empty($_smarty_tpl->tpl_vars['NEXT_RECORD_URL']->value)){?> disabled="disabled" <?php }else{ ?> onclick="window.location.href='<?php echo $_smarty_tpl->tpl_vars['NEXT_RECORD_URL']->value;?>
'" <?php }?>><i class="fa fa-angle-right"></i></button></span></div><?php }?></div><div class="detailViewInfo row-fluid"><div class="<?php if ($_smarty_tpl->tpl_vars['NO_PAGINATION']->value){?> span12 <?php }else{ ?> span10 <?php }?> <?php if (!empty($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEWTAB'])||!empty($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEWRELATED'])){?> details <?php }?>"><form id="detailView" data-name-fields='<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getNameFields());?>
' method="POST"><?php if (!empty($_smarty_tpl->tpl_vars['PICKLIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value="<?php echo Ncrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_DEPENDENCY_DATASOURCE']->value);?>
