<?php /* Smarty version Smarty-3.1.7, created on 2017-10-26 20:29:35
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2304959f23be5d442e9-37468495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8b55ec3ca4d5faa6cf7fdd57a79fae0d0a5912b' => 
    array (
  ...
  'nocache_hash' => '2304959f23be5d442e9-37468495',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59f23be602cbe',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
<?php if ($_valid && !is_callable('content_59f23be602cbe')) {function content_59f23be602cbe($_smarty_tpl) {?>
...
" type="text" class="qty smallInputBox" data-validation-engine="validate[required,funcCall[Ncrm_GreaterThanZero_Validator_Js.invokeValidation]]" value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value];?>
...
<?php }else{ ?>0<?php }?>" type="text" data-validation-engine="validate[required,funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" class="listPrice smallInputBox" list-info='<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value])){?><?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['listPriceValues']->value);?>
<?php }?>'/>&nbsp;<?php $_smarty_tpl->tpl_vars['PRICEBOOK_MODULE_MODEL'] = new Smarty_variable(Ncrm_Module_Model::getInstance('PriceBooks'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['PRICEBOOK_MODULE_MODEL']->value->isPermitted('DetailView')){?><img src="<?php echo vimage_path('PriceBooks.png');?>
...
</td><td><span class="pull-right">&nbsp;%</span><input type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" id="discount_percentage<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
...
</td><td><input type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" id="discount_amount<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
...
?><?php $_smarty_tpl->tpl_vars["taxname"] = new Smarty_variable((($_smarty_tpl->tpl_vars['tax_data']->value['taxname']).("_percentage")).($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><?php $_smarty_tpl->tpl_vars["tax_id_name"] = new Smarty_variable(("hidden_tax").($_smarty_tpl->tpl_vars['tax_row_no']->value)+((1).("_percentage")).($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><?php $_smarty_tpl->tpl_vars["taxlabel"] = new Smarty_variable((($_smarty_tpl->tpl_vars['tax_data']->value['taxlabel']).("_percentage")).($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><?php $_smarty_tpl->tpl_vars["popup_tax_rowname"] = new Smarty_variable(("popup_tax_row").($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><tr><td><input type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" name="<?php echo $_smarty_tpl->tpl_vars['taxname']->value;?>
