<?php /* Smarty version Smarty-3.1.7, created on 2017-10-26 15:08:01
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Ncrm\Comment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:485459f1fa51a23bd1-09979030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7829fa5ee929a4710afcc5dcb7de84be0ca41875' => 
    array (
  ...
  'nocache_hash' => '485459f1fa51a23bd1-09979030',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f1fa51ad14e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f1fa51ad14e')) {function content_59f1fa51ad14e($_smarty_tpl) {?>
...
</strong></span><span class="pull-right"><p class="muted"><small title="<?php echo Ncrm_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['COMMENT']->value->getCommentedTime());?>
"><?php echo Ncrm_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['COMMENT']->value->getCommentedTime());?>
...
</em></small>&nbsp;<small title="<?php echo Ncrm_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['COMMENT']->value->getModifiedTime());?>
" class="commentModifiedTime"><?php echo Ncrm_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['COMMENT']->value->getModifiedTime());?>
</small></p></span></span><?php }?></div></div><div class="row-fluid commentActionsDiv"><?php $_smarty_tpl->tpl_vars['COMMENTS_MODULE_MODEL'] = new Smarty_variable(Ncrm_Module_Model::getInstance('ModComments'), null, 0);?><div class="pull-right commentActions"><?php if ($_smarty_tpl->tpl_vars['CHILDS_ROOT_PARENT_MODEL']->value){?><?php $_smarty_tpl->tpl_vars['CHILDS_ROOT_PARENT_ID'] = new Smarty_variable($_smarty_tpl->tpl_vars['CHILDS_ROOT_PARENT_MODEL']->value->getId(), null, 0);?><?php }?><?php if ($_smarty_tpl->tpl_vars['COMMENTS_MODULE_MODEL']->value->isPermitted('EditView')){?><span><a class="cursorPointer replyComment"><i class="icon-share-alt"></i><?php echo vtranslate('LBL_REPLY',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
