<?php /* Smarty version Smarty-3.1.7, created on 2017-10-26 20:29:34
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2843259f23be5518a28-08168055%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6439d00ee623aeed41b6975e852295fe5f75beae' => 
    array (
  ...
  'nocache_hash' => '2843259f23be5518a28-08168055',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59f23be56caa8',
  'variables' => 
  array (
    'RELATED_PRODUCTS' => 0,
    'FINAL' => 0,
...
<?php if ($_valid && !is_callable('content_59f23be56caa8')) {function content_59f23be56caa8($_smarty_tpl) {?>
...
</td><td><span class="pull-right">&nbsp;%</span><input type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" id="discount_percentage_final" name="discount_percentage_final" value="<?php echo $_smarty_tpl->tpl_vars['FINAL']->value['discount_percentage_final'];?>
...
</td><td><input type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]"  id="discount_amount_final" name="discount_amount_final" value="<?php echo $_smarty_tpl->tpl_vars['FINAL']->value['discount_amount_final'];?>
" class="smallInputBox pull-right discount_amount_final discountVal <?php if ($_smarty_tpl->tpl_vars['DISCOUNT_TYPE_FINAL']->value!='amount'){?>hide<?php }?>" /></td></tr></tbody></table><div class="modal-footer lineItemPopupModalFooter modal-footer-padding"><div class=" pull-right cancelLinkContainer"><a class="cancelLink" type="reset" data-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 ...
 </b></span></td><td><span class="pull-right"><input id="shipping_handling_charge" name="shipping_handling_charge" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" type="text" class="lineItemInputBox" value="<?php if ($_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge']){?><?php echo $_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge'];?>
...
?><tr><td align="left" class="lineOnTop"><input type="text" size="5" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" name="<?php echo $_smarty_tpl->tpl_vars['tax_detail']->value['taxname'];?>
...
</div></td><td><input type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" name="<?php echo $_smarty_tpl->tpl_vars['tax_detail']->value['taxname'];?>
...
&nbsp;&nbsp;</div></div></td><td><span class="pull-right"><input id="adjustment" name="adjustment" type="text" data-validation-engine="validate[funcCall[Ncrm_PositiveNumber_Validator_Js.invokeValidation]]" class="lineItemInputBox" value="<?php if ($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']<0){?><?php echo abs($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']);?>
