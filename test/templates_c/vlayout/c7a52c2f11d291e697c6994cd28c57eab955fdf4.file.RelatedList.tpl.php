<?php /* Smarty version Smarty-3.1.7, created on 2017-10-29 03:00:32
         compiled from "E:\MXampp\sites\vtiger.dev\ncrm\includes\runtime/../../layouts/vlayout\modules\Campaigns\RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1887859f5445043b0e3-67840509%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7a52c2f11d291e697c6994cd28c57eab955fdf4' => 
    array (
  ...
  'nocache_hash' => '1887859f5445043b0e3-67840509',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f544505be4f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f544505be4f')) {function content_59f544505be4f($_smarty_tpl) {?>
...
" id='pageLimit'><input type="hidden" id="recordsCount" value=""/><input type="hidden" id="selectedIds" name="selectedIds" data-selected-ids=<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['SELECTED_IDS']->value);?>
...
"<?php }?><?php if (($_smarty_tpl->tpl_vars['IS_SELECT_BUTTON']->value==false)&&($_smarty_tpl->tpl_vars['IS_SEND_EMAIL_BUTTON']->value==false)){?>name="addButton"><i class="icon-plus"></i><?php }else{ ?>> <?php }?>&nbsp;<strong><?php echo $_smarty_tpl->tpl_vars['RELATED_LINK']->value->getLabel();?>
</strong></button></div><?php } ?>&nbsp;</div><div class="span3"><span class="customFilterMainSpan row-fluid"><?php if (count($_smarty_tpl->tpl_vars['CUSTOM_VIEWS']->value)>0){?><select id="recordsFilter" class="span12" data-placeholder="<?php echo vtranslate('LBL_SELECT_TO_LOAD_LIST',$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value);?>
...
" style="display:none;height:13px;margin-right:2px;vertical-align: middle;"><?php }else{ ?><input type="hidden" value="0" id="customFilter" /><?php }?></span></div><div class="span3"><div class="pull-right"><span class="pageNumbers"><span class="pageNumbersText"><?php if (!empty($_smarty_tpl->tpl_vars['RELATED_RECORDS']->value)){?> <?php echo $_smarty_tpl->tpl_vars['PAGING']->value->getRecordStartRange();?>
...
</span></span></li></ul><button class="btn" id="relatedListNextPageButton" <?php if ((!$_smarty_tpl->tpl_vars['PAGING']->value->isNextPageExists())||($_smarty_tpl->tpl_vars['PAGE_COUNT']->value==1)){?> disabled <?php }?> type="button"><span class="fa fa-arrow-right"></span></button></span></div></div></div></div><div id="selectAllMsgDiv" class="alert-block msgDiv"><strong><a id="selectAllMsg"><?php echo vtranslate('LBL_SELECT_ALL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><?php }?></a><?php }?></th><?php } ?><th nowrap colspan="2"><a href="javascript:void(0);" class="noSorting"><?php echo vtranslate('Status',$_smarty_tpl->tpl_vars['RELATED_MODULE']->value->get('name'));?>
...
"><span class="currentStatus btn-group"><span class="statusValue dropdown-toggle" data-toggle="dropdown"><?php echo vtranslate($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get('status'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
