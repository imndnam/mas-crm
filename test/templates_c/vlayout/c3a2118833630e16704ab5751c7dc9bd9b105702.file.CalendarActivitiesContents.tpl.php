<?php /* Smarty version Smarty-3.1.7, created on 2017-11-25 06:05:54
         compiled from "D:\LynxServer\sites\newcrm.dev\fb\includes\runtime/../../layouts/vlayout\modules\Ncrm\dashboards\CalendarActivitiesContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:116315a1908424165b1-28399287%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3a2118833630e16704ab5751c7dc9bd9b105702' => 
    array (
  ...
  'nocache_hash' => '116315a1908424165b1-28399287',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a19084247635',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a19084247635')) {function content_5a19084247635($_smarty_tpl) {?>
...
<?php }?>
			...
			<p class='pull-right muted' style='margin-top:5px;padding-right:5px;'><small title="<?php echo Ncrm_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['START_DATE']->value)." ".($_smarty_tpl->tpl_vars['START_TIME']->value));?>
 <?php echo vtranslate('LBL_TO');?>
 <?php echo Ncrm_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['DUE_DATE']->value)." ".($_smarty_tpl->tpl_vars['DUE_TIME']->value));?>
"><?php echo Ncrm_Util_Helper::formatDateDiffInStrings(($_smarty_tpl->tpl_vars['START_DATE']->value)." ".($_smarty_tpl->tpl_vars['START_TIME']->value));?>
</small></p>
