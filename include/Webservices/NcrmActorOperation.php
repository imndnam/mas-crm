...
require_once 'include/Webservices/NcrmCRMActorMeta.php';
class NcrmActorOperation extends WebserviceEntityOperation {
	...
	protected function getMetaInstance(){
		if(empty(WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id])){
			WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id]  
					= new NcrmCRMActorMeta($this->entityTableName,$this->webserviceObject,$this->pearDB,$this->user);
		}
	...
	protected function getActorTables(){
		...
		$sql = 'select table_name, webservice_entity_id from ncrm_ws_entity_tables';
