...
#line 451 "e:\workspace\nonadmin\pkg\ncrm\extensions\Webservices\VTQL_parser.y"
class VTQL_Parser#line 102 "e:\workspace\nonadmin\pkg\ncrm\extensions\Webservices\VTQL_parser.php"
{
...
Array ( 
	...
	[tableName] => ncrm_crmentity,ncrm_contactdetails,ncrm_contactaddress,ncrm_contactsubdetails,ncrm_contactscf,ncrm_customerdetails 
...
if($firstTable!=$table){
	if(!isset($tabNameIndex[$table]) && $table == "ncrm_crmentity"){
