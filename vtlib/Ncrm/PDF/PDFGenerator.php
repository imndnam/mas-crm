...
class Ncrm_PDF_Generator {
	...
	function __construct() {
		$this->pdf = new Ncrm_PDF_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);
	...
	function createLastPage() {
		...
		if ($totalHeightFooter) {
			$this->footerFrame = new Ncrm_PDF_Frame();
	...
	function createPage($isLastPage = false) {
		...
		if ($totalHeightHeader) {
			$this->headerFrame = new Ncrm_PDF_Frame();
		...
		// ContentViewer
		$this->contentFrame = new Ncrm_PDF_Frame();
