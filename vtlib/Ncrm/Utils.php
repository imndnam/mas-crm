 ...
 */
class Ncrm_Utils {
    protected static $logFileName = 'ncrmmodule.log';
	...
	static function Log($message, $delimit=true) {
		global $Ncrm_Utils_Log, $log;
		
		$log->debug($message);
		if(!isset($Ncrm_Utils_Log) || $Ncrm_Utils_Log == false) return;
	...
	static function CheckTable($tablename) {
		...
		$tablename = Ncrm_Utils::SQLEscape($tablename);
