...
include_once 'modules/Ncrm/CRMEntity.php';

class ModuleName extends Ncrm_CRMEntity {
	var $table_name = 'ncrm_<modulename>';
	var $table_index= '<modulename>id';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('ncrm_<modulename>cf', '<modulename>id');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('ncrm_crmentity', 'ncrm_<modulename>', 'ncrm_<modulename>cf');
	...
	var $tab_name_index = Array(
		...
		'ncrm_<modulename>' => '<modulename>id',
		'ncrm_<modulename>cf'=>'<modulename>id');
