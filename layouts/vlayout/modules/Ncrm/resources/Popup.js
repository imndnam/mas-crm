...
jQuery.Class("Ncrm_Popup_Js",{
    ...
    getInstance: function(){
		...
		var fallbackClassName = Ncrm_Popup_Js;
	...
	show : function(urlOrParams, cb, windowName, eventName, onLoadCb){
		...
		if(typeof cb != 'undefined') {
		 ...
		 if(typeof onLoadCb == 'function') {
			jQuery.windowMsg('Ncrm.OnPopupWindowLoad.Event', function(data){
				onLoadCb(data);
            })
        }
	...
	getPageRecords : function(params){
		...
		Ncrm_BaseList_Js.getPageRecords(params).then(
				function(data){
