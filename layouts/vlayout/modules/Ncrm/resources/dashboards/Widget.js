...
jQuery.Class('Ncrm_Widget_Js',{

	widgetPostLoadEvent : 'Vtiget.Dashboard.PostLoad',
	widgetPostRefereshEvent : 'Ncrm.Dashboard.PostRefresh',
	...
	getInstance : function(container, widgetName, moduleName) {
		...
		var fallbackClass = window["Ncrm_"+widgetClassName+"_Widget_Js"];

		var basicClass = Ncrm_Widget_Js;
	...
	refreshWidget : function() {
		...
		AppConnector.request(params).then(
			function(data){
				...
				contentContainer.html(data).trigger(Ncrm_Widget_Js.widgetPostRefereshEvent);
			},
			function(){
				refreshContainer.progressIndicator({'mode': 'hide'});
			}
	...
	registerWidgetPostLoadEvent : function(container) {
		var thisInstance = this;
		container.on(Ncrm_Widget_Js.widgetPostLoadEvent, function(e) {
	...
	registerWidgetPostRefreshEvent : function(container) {
		var thisInstance = this;
		container.on(Ncrm_Widget_Js.widgetPostRefereshEvent, function(e) {
...
Ncrm_Widget_Js('Ncrm_History_Widget_Js', {}, {
...
Ncrm_Widget_Js('Ncrm_Funnel_Widget_Js',{},{
...
Ncrm_Widget_Js('Ncrm_Pie_Widget_Js',{},{
...
Ncrm_Widget_Js('Ncrm_Barchat_Widget_Js',{},{
...
Ncrm_Widget_Js('Ncrm_MultiBarchat_Widget_Js',{
...
Ncrm_Widget_Js('Ncrm_Minilist_Widget_Js', {}, {
...
Ncrm_Widget_Js('Ncrm_Tagcloud_Widget_Js',{},{
...
/* Notebook Widget */
Ncrm_Widget_Js('Ncrm_Notebook_Widget_Js', {
