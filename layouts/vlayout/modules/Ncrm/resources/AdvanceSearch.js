...
Ncrm_BasicSearch_Js("Ncrm_AdvanceSearch_Js",{
	...
	getAdvanceSearch : function() {
		...
		//Exists in the cache
		if(searchModule in Ncrm_AdvanceSearch_Js.cache) {
			aDeferred.resolve(Ncrm_AdvanceSearch_Js.cache[searchModule]);
			return aDeferred.promise();
		}
        
        //if you are in settings then module should be ncrm
		...
		AppConnector.request(searchableModulesParams).then(
			function(data){
				...
				//add to cache
				Ncrm_AdvanceSearch_Js.cache[searchModule] = data;
	...
	initiateSearch : function() {
		...
		var postLoad = function(uiData) {
			...
			thisInstance.advanceFilter = new Ncrm_SearchAdvanceFilter_Js(jQuery('.filterContainer',uiData));
