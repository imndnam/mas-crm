...
jQuery.Class("Ncrm_AdvanceFilter_Js",{
	...
	loadFieldSpecificUi : function(fieldSelect) {
		...
		var fieldModel = Ncrm_Field_Js.getInstance(fieldInfo,moduleName);
	...
	addValidationToFieldIfNeeded : function(selectFieldElement) {
		...
		if(this.isFieldSupportsValidation(selectFieldElement)) {
			...
			fieldSpecificElement.addClass('validate[funcCall[Ncrm_Base_Validator_Js.invokeValidation]]')
								.attr('data-validation-engine','validate[funcCall[Ncrm_Base_Validator_Js.invokeValidation]]')
								.attr('data-fieldinfo', JSON.stringify(selectedOption.data('fieldinfo')));
            if(typeof validator!='undefined') {
                fieldSpecificElement.attr('data-validator',validator);
            }
		}else{
			fieldSpecificElement.removeClass('validate[funcCall[Ncrm_Base_Validator_Js.invokeValidation]]')
...
Ncrm_Field_Js('AdvanceFilter_Field_Js',{},{
...
Ncrm_Picklist_Field_Js('AdvanceFilter_Picklist_Field_Js',{},{
...
Ncrm_Multipicklist_Field_Js('AdvanceFilter_Multipicklist_Field_Js',{},{
...
Ncrm_Owner_Field_Js('AdvanceFilter_Owner_Field_Js',{},{
...
Ncrm_Date_Field_Js('AdvanceFilter_Date_Field_Js',{},{
	/**
