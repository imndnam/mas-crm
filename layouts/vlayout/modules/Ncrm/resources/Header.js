...
jQuery.Class("Ncrm_Header_Js", {
    ...
    getQuickCreateForm: function(url, moduleName, params) {
        ...
        if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
            if (typeof Ncrm_Header_Js.quickCreateModuleCache[moduleName] != 'undefined') {
                aDeferred.resolve(Ncrm_Header_Js.quickCreateModuleCache[moduleName]);
        ...
        AppConnector.request(requestParams).then(function(data) {
            if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
                Ncrm_Header_Js.quickCreateModuleCache[moduleName] = data;
            }
...
//        }
    ...
    registerCalendarButtonClickEvent: function() {
        ...
        var ncrmDateFormat = app.convertToDatePickerFormat(dateFormat);
    ...
    handleQuickCreateData: function(data, params) {
        ...
        app.showModalWindow(data, function(data) {
            ...
            var editViewInstance = Ncrm_Edit_Js.getInstanceByModuleName(moduleName);
        ...
        form.on('submit', function(e) {
            ...
            if (typeof form.data('submit') != "undefined") {
                ...
                if (!(recordPreSaveEvent.isDefaultPrevented())) {
                    ...
                    var moduleInstance = Ncrm_Edit_Js.getInstanceByModuleName(module);
                    ...
                    targetInstance.quickCreateSave(form).then(
                            function(data) {
                                ...
                                if((module == parentModule) && (viewname=="List")){ 
                                    var listinstance = new Ncrm_List_Js();
    ...
    labelSearch: function(currentTarget) {
        ...
        var basicSearch = new Ncrm_BasicSearch_Js();
    ...
    registerEvents: function() {
		...
		if(jQuery.browser.msie && jQuery.browser.version < 9.0) {
			if(app.getCookie('oldbrowser') != 'true') {
				...
				window.location.href = 'layouts/vlayout/modules/Ncrm/browsercompatibility/Browser_compatibility.html';
			}
		}

        jQuery('#globalSearch').click(function() {
            var advanceSearchInstance = new Ncrm_AdvanceSearch_Js();
		...
		$(document).ajaxComplete(function() {
			 Ncrm_Header_Js.getInstance().adjustContentHeight();
		});
...
jQuery(document).ready(function() {
    ...
    Ncrm_Header_Js.getInstance().registerEvents();
