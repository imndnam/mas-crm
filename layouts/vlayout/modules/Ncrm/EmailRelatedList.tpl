...
<div class="span6">
    <div class="pull-right">
        ...
        <span class="btn-group">
            <button class="btn" id="relatedListPreviousPageButton" {if !$PAGING->isPrevPageExists()} disabled {/if} type="button"><span class="fa fa-arrow-left"></span></button>
            ...
            <button class="btn" id="relatedListNextPageButton" {if (!$PAGING->isNextPageExists()) or ($PAGE_COUNT eq 1)} disabled {/if} type="button"><span class="fa fa-arrow-right"></span></button>
        </span>
    </div>
</div>
</div>
            ...
            {foreach item=RELATED_RECORD from=$RELATED_RECORDS}
				...
				{/if}
                            ...
                            {elseif $RELATED_HEADERNAME eq 'parent_id'}
                                ...
                                {assign var=UI_TYPE_MODEL value=Ncrm_Base_UIType::getInstanceFromField($RECORD_FIELD_MODEL)}
