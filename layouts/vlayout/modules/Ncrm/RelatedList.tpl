...
<div class="span6">
    <div class="pull-right">
        ...
        <span class="btn-group">
            <button class="btn" id="relatedListPreviousPageButton" {if !$PAGING->isPrevPageExists()} disabled {/if} type="button"><span class="fa fa-angle-left"></span></button>
            ...
            <button class="btn" id="relatedListNextPageButton" {if (!$PAGING->isNextPageExists()) or ($PAGE_COUNT eq 1)} disabled {/if} type="button"><span class="fa fa-angle-right"></span></button>
        </span>
    </div>
</div>
</div>
