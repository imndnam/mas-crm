...
jQuery.Class("Settings_Ncrm_ConfigEditor_Js",{},{
...
jQuery(document).ready(function(e){
	var tacInstance = new Settings_Ncrm_ConfigEditor_Js();
	tacInstance.registerEvents();
})

Ncrm_WholeNumberGreaterThanZero_Validator_Js("Ncrm_NumberRange5_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ncrm_NumberRange5_Validator_Js();
...
Ncrm_WholeNumberGreaterThanZero_Validator_Js("Ncrm_NumberRange100_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ncrm_NumberRange100_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
