 ...
 * All Rights Reserved.
 *************************************************************************************/
Ncrm_AdvanceFilter_Js('Workflows_AdvanceFilter_Js',{},{
...
Ncrm_Field_Js('Workflows_Field_Js',{},{
...
Ncrm_Date_Field_Js('Workflows_Date_Field_Js',{},{
	...
	getUi : function() {
		...
		if(comparatorSelectedOptionVal.length > 0) {
			if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
				...
				var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[Ncrm_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
...
Ncrm_Date_Field_Js('Workflows_Datetime_Field_Js',{},{
	/**
	 * Function to get the user date format
	 */
	getDateFormat : function(){
...
Ncrm_Currency_Field_Js('Workflows_Currency_Field_Js',{},{
...
Ncrm_Time_Field_Js('Workflows_Time_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Percentage_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Text_Field_Js',{},{
...
Ncrm_Field_Js('Ncrm_Boolean_Field_Js',{},{
...
Ncrm_Owner_Field_Js('Workflows_Owner_Field_Js',{},{
...
Ncrm_Picklist_Field_Js('Workflows_Picklist_Field_Js',{},{
