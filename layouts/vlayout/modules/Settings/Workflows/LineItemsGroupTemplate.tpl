    ...
    <table border=1 style="font-size:11px; width:100%; table-layout: fixed; border-collapse: collapse;">
        <thead>
              ...
              <!-- /foreach -->
                ...
                <tr>
                    <td colspan=7 style="word-wrap: break-word; text-align: right;">Shipping & Handling Charges</td>
                    <td style="text-align: right; word-wrap: break-word;">
                         {literal}{$RECORD.hdnS_H_Amount}{/literal}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan=7 style="word-wrap: break-word; text-align: right;">
                        Shipping &amp Handling Tax total amount({literal}{$RECORD.shtax_totalpercent}{/literal} %)
                    </td>
                    <td style="text-align: right; word-wrap: break-word;">
                        {literal}{$RECORD.shtax_totalamount}{/literal}
                    </td>
                </tr>
                <tr>
                    <td colspan=7 style="word-wrap: break-word; text-align: right;">Adjustment</td>
                    <td style="text-align:right; word-wrap: break-word;">
                        {literal}{$RECORD.txtAdjustment}{/literal}
                    </td>
                </tr>
                <tr>
                    <td colspan=7 style="word-wrap: break-word; text-align: right;">
