...
jQuery.Class('Settings_LayoutEditor_Js', {
	...
	setFieldDetails : function(result, form) {
		...
		var fieldModel = Ncrm_Field_Js.getInstance(result);
		...
		defaultValueUi.find('[data-validation-engine]').attr('data-validation-engine','validate[required,funcCall[Ncrm_Base_Validator_Js.invokeValidation]]');
...
Ncrm_WholeNumberGreaterThanZero_Validator_Js("Ncrm_FloatingDigits_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ncrm_FloatingDigits_Validator_Js();
...
Ncrm_WholeNumberGreaterThanZero_Validator_Js("Ncrm_DecimalMaxLength_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ncrm_DecimalMaxLength_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
...
Ncrm_WholeNumberGreaterThanZero_Validator_Js("Ncrm_MaxLength_Validator_Js",{
...
Ncrm_Base_Validator_Js("Ncrm_PicklistFieldValues_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new Ncrm_PicklistFieldValues_Validator_Js();
		instance.setElement(field);
		var response = instance.validate();
		if(response != true){
			return instance.getError();
