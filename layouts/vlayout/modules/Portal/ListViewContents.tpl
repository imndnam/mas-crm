                    ...
                    {if $PAGING_INFO['recordCount'] eq '0'}
                        <table class="emptyRecordsDiv">
                            <tbody>
                                <tr>
                                    <td>
                                        {vtranslate('LBL_EQ_ZERO')} {vtranslate('LBL_BOOKMARKS', $MODULE)} {vtranslate('LBL_FOUND')}. {vtranslate('LBL_CREATE')} <a class="addBookmark">{vtranslate('LBL_BOOKMARK', $MODULE)}</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
