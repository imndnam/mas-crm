		...
		<form class="form-horizontal" name="step1" method="post" action="index.php">
			...
			<div class="row-fluid">
				<div class="span4 welcome-image">
					<img src="{'wizard_screen.png'|vimage_path}" alt="Ncrm Logo"/>
				</div>
				<div class="span8">
					<div class="welcome-div">
						<h3>{vtranslate('LBL_WELCOME_TO_NCRM6_SETUP_WIZARD', 'Install')}</h3>
						{vtranslate('LBL_NCRM6_SETUP_WIZARD_DESCRIPTION','Install')}
					</div>
