...
Ncrm_Edit_Js("Accounts_Edit_Js",{
   ...
   memberOfAddressFieldsMapping : {
	...
	registerRecordPreSaveEvent : function(form) {
		...
		form.on(Ncrm_Edit_Js.recordPreSave, function(e, data) {
            ...
            if(!(accountName in thisInstance.duplicateCheckCache)) {
                Ncrm_Helper_Js.checkDuplicateName({
	...
	registerReferenceSelectionEvent : function(container) {
		...
		jQuery('input[name="account_id"]', container).on(Ncrm_Edit_Js.referenceSelectionEvent, function(e, data){
	...
	registerBasicEvents : function(container) {
		...
		this.registerReferenceSelectionEvent(container);
			//container.trigger(Ncrm_Edit_Js.recordPreSave, {'value': 'edit'});
	}
});