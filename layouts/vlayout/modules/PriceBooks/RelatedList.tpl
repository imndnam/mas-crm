            ...
            <div class="pull-right">
                ...
                <div class="span4">
                    <span class="btn-group pull-right">
                        <button class="btn" id="relatedListPreviousPageButton" {if !$PAGING->isPrevPageExists()} disabled="disabled" {/if} type="button"><span class="fa fa-arrow-left"></span></button>
                        ...
                        <button class="btn" id="relatedListNextPageButton" {if (!$PAGING->isNextPageExists()) or ($PAGE_COUNT eq 1)} disabled="disabled" {/if} type="button"><span class="fa fa-arrow-right"></span></button>
                    </span>
                </div>
            </div>
            </span>
