...
// helpdesk support email id and support name (Example: 'support@ncrm.com' and 'ncrm support')
$HELPDESK_SUPPORT_EMAIL_ID = 'admin@admin.com';
...
$dbconfig['db_server'] = $jsonConfig['db_server'];
$dbconfig['db_port'] = $jsonConfig['db_port'];
$dbconfig['db_username'] = $jsonConfig['db_username'];
$dbconfig['db_password'] = $jsonConfig['db_password'];
$dbconfig['db_name'] = $jsonConfig['db_name'];
$dbconfig['db_type'] = $jsonConfig['db_type'];
$dbconfig['db_status'] = $jsonConfig['db_status'];
...
$site_URL = $jsonConfig['site_url'];

// url for customer portal (Example: http://ncrm.com/portal)
$PORTAL_URL = $site_URL.'/customerportal';
// root directory path
$root_directory = $jsonConfig['root_dir'];
...
//Disable Stat Tracking of NCRM instance
$disable_stats_tracking = false;

// Generating Unique Application Key
$application_unique_key = '135b331e539cc90ac51a7bfc931aec54';
...
$globalSiteName = $jsonConfig['crm_name'];
