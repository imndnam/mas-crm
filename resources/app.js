...
var app = {
	...
	getDateInNcrmFormat: function(dateFormat,dateObject){
	...
	registerEventForDatePickerFields : function(parentElement,registerForAddon,customParams){
		...
		element.each(function(index,domElement){
			...
			var selectedDate = app.getDateInNcrmFormat(dateFormat, dateObj);
	...
	registerEventForDateFields : function(parentElement) {
		...
		element.datepicker({'autoclose':true}).on('changeDate', function(ev){
			...
			var finalFormat = app.getDateInNcrmFormat(dateFormat,ev.date);
	...
	setContentsHeight : function() {
		...
		jQuery('.mainContainer').css('min-height',(jQuery(window).innerHeight()-borderTopWidth));
		jQuery('.contentsDiv').css('min-height',(jQuery(window).innerHeight()-borderTopWidth));
	},
	...
	getPageController : function() {
		...
		if(typeof window[moduleClassName] == 'undefined'){
			moduleClassName = parentModule+"_Ncrm_"+view+"_Js";
		}
		if(typeof window[moduleClassName] == 'undefined') {
			moduleClassName = moduleName+"_"+view+"_Js";
		}
		if(typeof window[moduleClassName] == 'undefined') {
			moduleClassName = "Ncrm_"+view+"_Js";
		}
        if(typeof window[moduleClassName] != 'undefined') {
...
jQuery(document).ready(function(){
	...
	// Header bar events
	jQuery('.enable-search').click(function () {
		$(this).hide();
		jQuery('#headerLinksBig .navbar-search').fadeIn();
    });

	jQuery('.close-search').click(function () {
        jQuery('.enable-search').fadeIn();
        jQuery('#headerLinksBig .navbar-search').hide();
    });
});
